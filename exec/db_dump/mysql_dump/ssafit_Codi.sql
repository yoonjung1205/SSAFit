...
CREATE TABLE `Codi` (
  ...
  `codiImg` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `codiTitle` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hashtags` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tpo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `UK_pwwintqvip3coos0de8toc7px` (`CODI_ID`)
...
-- Dump completed on 2022-04-05 11:57:37
